...
public class SearchStudentByName extends Stage {
	public Student foundStudent;
	{
		this.setTitle("Search Students by Name");
		VBox vb = new VBox();
		vb.setSpacing(15);
		...
		srch.setOnAction(new EventHandler<ActionEvent>(){
			public void handle(ActionEvent arg0) {
				for (Student student : Application.getStudents()) {
					if (student.getFirstName().toLowerCase().contains(txt1.getText().toLowerCase())){
